...
fun CobInfo.withAimiResultCob(loop: Loop, now: Long, latestCarbsChangeTime: Long = 0L): CobInfo {
    ...
    if (latestCarbsChangeTime > result.date) return this
    ...
    val existingCob = displayCob
    if (existingCob != null && existingCob > aimiCob + 0.5) return this
